                ...
                <div className="sc-1dnk851-0 yIDuG">
                    ...
                    <div className="sc-1dnk851-2 dBfFrV">
                        <div className="sc-1dnk851-3 eqMbma">
                            ...
                            <div className="sc-1dnk851-4 bIvKIx">
                                <div className="sc-sx9n2y-0 kivXvb sc-1dnk851-5 gPvwIm css-1w21yux">
                                    1W
                                </div>
                            </div>
                            <div className="sc-1dnk851-4 bIvKIx">
                            ...
                            <thead className="rgw6ezrd rgw6ez50p rgw6ez7jr rgw6ez7ar">
                                <tr role="row">
                                    <th
                                        ...
                                        role="columnheader"
                                        disabled=""
                                        style={{ textAlign: "left", paddingLeft: 52 }}
                                    >
                                    ...
                                    >
                                        <span className="_1klryar0 rgw6ez4bp rgw6ez491" />
                                        <span className="_1klryar0 rgw6ez2cp">Floor change</span>
                                    </th>
                                    <th
                                        className="sc-iwpsza-3 kSSCXd _1mor7ved rgw6ezcp rgw6ezav rgw6eze7 rgw6ez4ep rgw6ez2ov rgw6ez28d"
                                        colSpan={1}
                                    ...
                                    >
                                        ...
                                        <span className="_1klryar0 rgw6ez2ed">Volume</span>
                                    </th>
                                    <th
                                        className="sc-iwpsza-3 kSSCXd _1mor7ved rgw6ezcp rgw6ezav rgw6eze7 rgw6ez4ep rgw6ez2ov rgw6ez28d"
                                        colSpan={1}
                                    ...
                                    >
                                        <span className="_1klryar0 rgw6ez4bp rgw6ez491" />
                                        <span className="_1klryar0 rgw6ez2cp">Volume change</span>
                                    </th>
                                    <th
                                        className="sc-iwpsza-3 kSSCXd _1mor7ved rgw6ezcp rgw6ezav rgw6eze7 rgw6ez4ep rgw6ez2ov rgw6ez28d"
                                        colSpan={1}
                                    ...
                                    >
                                        <span className="_1klryar0 rgw6ez4bp rgw6ez491" />
                                        <span className="_1klryar0 rgw6ez2cp">Items</span>
                                    </th>
                                    <th
                                        className="sc-iwpsza-3 kSSCXd _1mor7ved rgw6ezcp rgw6ezav rgw6eze7 rgw6ez4ep rgw6ez2ov rgw6ez28d"
                                        colSpan={1}
                                    ...
                                    >
                                        <span className="_1klryar0 rgw6ez4bp rgw6ez491" />
                                        <span className="_1klryar0 rgw6ez2cp">Owners</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody role="rowgroup">
                                ...
                                >
                                    ...
                                    >
                                        <div className="sc-iwpsza-0 jNQukZ">
                                            <div className="sc-sx9n2y-0 bftkTM css-1cjl26j">1</div>
                                    ...
                                    >
                                        <div className="sc-1qdt28z-7 eCRqrV">
                                            <div className="sc-sx9n2y-0 kivXvb css-1jljtub">5.1 ETH</div>
                                        </div>
                                    ...
                                    >
                                        <div className="sc-1qdt28z-6 glsCXl">
                                            ...
                                            <div className="sc-sx9n2y-0 kandXm css-1jljtub">27%</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
                                    ...
                                    >
                                        <div className="sc-1qdt28z-7 eCRqrV">
                                            <div className="sc-sx9n2y-0 kivXvb css-1jljtub">4,505 ETH</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
                                    ...
                                    >
                                        <div className="sc-1qdt28z-6 bGFXDY">
                                            ...
                                            <div className="sc-sx9n2y-0 kandXm css-1jljtub">189%</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
                                ...
                                >
                                    ...
                                    >
                                        <div className="sc-iwpsza-0 jNQukZ">
                                            <div className="sc-sx9n2y-0 bftkTM css-1cjl26j">2</div>
                                            <div className="sc-1qdt28z-0 sc-1qdt28z-1 iQoJCd haocDl">
                                                <div
                                                    src="https://i.seadn.io/gae/Ju9CkWtV-1Okvf45wo8UctR-M9He2PjILP0oOvxE89AyiPPGtrR3gysu1Zgy0hjd2xKIgjJJtWIc0ybj4Vd7wv8t3pxDGHoJBzDB?w=500&auto=format"
                                                    className="sc-1qdt28z-5 hctmmU"
                                                />
                                                <div className="sc-1qdt28z-0 sc-1qdt28z-2 iQoJCd dOdauD">
                                                    <div className="sc-sx9n2y-0 kivXvb sc-1qdt28z-3 FYrkO css-rjqme">
                                                        Bored Ape Yacht Club
                                    ...
                                    >
                                        <div className="sc-1qdt28z-7 eCRqrV">
                                            <div className="sc-sx9n2y-0 kivXvb css-1jljtub">29.94 ETH</div>
                                        </div>
                                    ...
                                    >
                                        <div className="sc-1qdt28z-6 glsCXl">
                                            ...
                                            <div className="sc-sx9n2y-0 kandXm css-1jljtub">1%</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
                                    ...
                                    >
                                        <div className="sc-1qdt28z-7 eCRqrV">
                                            <div className="sc-sx9n2y-0 kivXvb css-1jljtub">868 ETH</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
                                    ...
                                    >
                                        <div className="sc-1qdt28z-6 glsCXl">
                                            ...
                                            <div className="sc-sx9n2y-0 kandXm css-1jljtub">19%</div>
                                        </div>
                                    </td>
                                    <td
                                        className="_1mor7vef rgw6ezcp rgw6ezb1 rgw6ezed rgw6ez2o7 rgw6ez27p rgw6ez1jp rgw6ez467 rgw6ez491"
